  ...
  return (
    <>
      <div className="flex sm:flex-row items-center sm:items-start sm:justify-center flex-col gap-x-10 gap-y-6 w-screen  md:gap-x-20">
        <div className={` overflow-hidden bg-[#371650] w-60 ${isCollapsed("todo") ? "h-[5vh]":`${hastask(todoStatus)?"sm:h-[80vh] h-[25vh] overflow-y-auto":"h-auto "}`} `}>
          <div className="flex justify-center">
            <h3>To Do</h3>
            <button onClick={() => handleCollapse("todo")}>
              { isCollapsed("todo")?"▶️":"🔽"}
            </button>
          </div>
        ...
        <div className={` overflow-hidden bg-[#371650] w-60 ${isCollapsed("inProgress") ? "h-[5vh]":`${hastask(inProgressStatus)? " sm:h-[80vh] h-[25vh] overflow-y-auto":"h-auto "}`}`}>
          <div className="flex justify-center">
            <h3>In Progress</h3>
            <button onClick={() => handleCollapse("inProgress")}>
              { isCollapsed("inProgress")?"▶️":"🔽"}</button>
          </div>
          {loading
            ? renderSkeletons(2)
        ...
        <div className={`overflow-hidden bg-[#371650]  w-60 ${isCollapsed("done") ? "h-[5vh]":`${hastask(doneStatus)?"sm:h-[80vh] h-[25vh] overflow-y-auto":"h-auto "}`}`}>
          <div className="flex  justify-center">
            <h3>Done</h3>
