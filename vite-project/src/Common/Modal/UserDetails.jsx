...
import {updateUser} from "../../services/TaskService"
...
const today = new Date().toISOString().split("T")[0];
  ...
  async function saveData(formData){
   ...
   await updateUser( { id: currUser.id,
...
<div >
           <div className="ml-10"> <img src={Mask} width="40px"/></div> 
            
             <span>User Name: <span>{currUser.UserName}</span></span>
 </div>
...
<Input
 ...
 <div className=" h-full w-full">
        ...
        <Input
          ...
          register={register}
          name="PhoneNumber"
          error={errors.phone} className={'inputfield2'}
        />
        ...
        <Input
          ...
          register={register}
          name="dob"
          error={errors.dob} className={'inputfield2'}
          max={today}
        />
        ...
        <Input
          ...
          register={register}
          name="zip"
          error={errors.zip} className={'inputfield2'}
        />
